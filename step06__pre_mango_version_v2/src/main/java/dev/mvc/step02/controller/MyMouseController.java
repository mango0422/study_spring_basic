...
import dev.mvc.step02.dto.MyMouseDTO;
import dev.mvc.step02.model.Mouse;
import dev.mvc.step02.service.MyMouseService;

@Controller
@RequestMapping("/mango/mouse-api/mice")
public class MyMouseController {
    private static final Logger logger = LoggerFactory.getLogger(HomeController.class);
    private final MyMouseService mouseService;

    @Autowired
    public MyMouseController(MyMouseService mouseService) {
    ...
    public String register(@ModelAttribute MyMouseDTO mouseDTO) {
